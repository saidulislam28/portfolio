...
const Skill = ({ skills }) => {
  return (
    <div id="skill1" className="p-2">
      <h5
        id="skills"
        className="text-xl lg:text-3xl font-semibold text-white text-center my-10 border-b-4 w-[70%] lg:w-[22%] mx-auto py-5 border-yellow-400 "
      >
        Technical Skills
      </h5>
        ...
        <div className="my-skills shadow-xl shadow-yellow-400">
          <div className="bg">
            <div className="h-full flex flex-col justify-center items-center gap-2">
              <h1 className="text-2xl flex flex-col items-center font-bold text-white">
                HTML5
                <span className="text-sm mt-2 text-gray-200 font-normal">
                  intermediate
                </span>
              </h1>
